...
function cart() {
  ...
  var tannyr = raice, brinleigh = tannyr(561) +     $_config[tannyr(667)][tannyr(265)] && (brinleigh += '            <input type="number" name="email" placeholder="' + $_config[tannyr(710)][tannyr(383)] + tannyr(447));
$_config[tannyr(710)][tannyr(711)] + tannyr(326) + $_config[tannyr(710)].checkout_phone + tannyr(640);
