...
function cart() {
  ...
  $_config[tannyr(667)][tannyr(265)] && (brinleigh += '            <input type="text" name="resi" placeholder="' + $_config[tannyr(710)].checkout_note + tannyr(447));
  ...
  $(tannyr(337)).on(tannyr(676), function (iredell) {
    ...
    if (!confirm($_config[telicia(710)][telicia(307)])) return; else {
      ...
      izick += telicia(650) + (annaliisa ? $_config.text.cart_weight + telicia(470) + kg(annaliisa) + "*\n" : "") + telicia(263) + $_config[telicia(710)][telicia(645)] + telicia(700) + dyanna + " " + $_config[telicia(710)][telicia(308)] + " ) = *" + format_currency(jayloni) + "*\n                \n                — — — — — — — — — — — — — — —\n   📋 Informasi Penjual : \n " + (jeanettie.resi ? "*" + $_config[telicia(710)].checkout_resi + telicia(387) + jeanettie[telicia(265)] + "\n\n" : "") + " \n  " + (jeanettie.email ? "*" + $_config[telicia(710)][telicia(383)] + telicia(387) + jeanettie[telicia(265)] + "\n\n" : "")  + $_config[telicia(710)][telicia(713)] + telicia(387) + (jeanettie[telicia(346)] ? "-" + jeanettie.note : "-") + "       \n                — — — — — — — — — — — — — — —\n   \n                📋 " + $_config[telicia(710)][telicia(691)] + telicia(352) + jeanettie[telicia(303)] + telicia(287) + jeanettie.phone + telicia(536)  + telicia(263) + (jeanettie[telicia(271)] ? "" + $_config[telicia(710)][telicia(703)] + telicia(329) + jeanettie.address + "\n" : "") + telicia(372)  + telicia(641) + (jeanettie[telicia(595)] ? "" + $_config[telicia(710)].checkout_shipping + "* : " + jeanettie[telicia(595)] + "\n" + $_config.checkout_form_shipping[jeanettie.shipping][telicia(526)] + "\n\n" : "") + telicia(263) + (jeanettie[telicia(328)] ? "*" + $_config[telicia(710)][telicia(508)] + telicia(387) + jeanettie[telicia(328)] + "\n" + $_config[telicia(273)][jeanettie[telicia(328)]][telicia(526)] + "\n\n" : "") + telicia(468) + location.protocol + "//" + location[telicia(530)] + "            ", izick = izick[telicia(696)]("  ", "").replaceAll(telicia(483), telicia(579)), izick = encodeURIComponent(izick);
