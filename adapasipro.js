...
function cart() {
  ...
  $_config[tannyr(667)][tannyr(265)] && (brinleigh += '            <input type="text" name="note" placeholder="' + $_config[tannyr(710)].checkout_note + tannyr(447));
